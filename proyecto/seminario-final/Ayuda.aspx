<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Ayuda.aspx.cs" Inherits="seminario_final.Ayuda" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cuerpo" runat="server">
    ...
    <br>
                                    ...
                                    <br>
                                    <a href="https://elpuentegrafica.com.ar/David/seminario-final/ar.html">Análisis de productos</a> <small>(Se recomienda acceder con un celular)</small>
                                    <br>
                                    En donde se deberá, mediante el uso de la cámara, enfocar la siguiente imagen:
    <br>
                                    <img width="50%" src="images/codigo.jpg">
                                    <br>
                                    <br>
