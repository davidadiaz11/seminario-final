...
<head runat="server">
    <title>Alimentate Con-Ciencia</title>
    <meta charset="utf-8" />
                    ...
                    <form class="forms-sample" runat="server">
                        ...
                        <div class="col-12 align-items-stretch" style="background-color:#fdf9c4">
                            ...
                            <div class="text-center">
                                <small class="text-black">Dentro del sitio se explica paso a paso cómo usar: <a href="Ayuda">Click aquí para ver la ayuda</a></small>
                            </div>
                            <br />
                            <br />
                        </div>
                        ...
                        <div style="background-color: #c5c6c8">
                            ...
                            <div class="col-12 align-items-stretch text-center">
                                ...
                                <br />
                                <a class="btn btn-outline-primary mt-1 botones" rel="noopener noreferrer" target="_blank" href="#"><i class="mdi mdi-facebook-messenger"></i>Enviar Mensaje</a>
                                <br />
                                <br />
                            </div>
                        </div>
